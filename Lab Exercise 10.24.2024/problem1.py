#Lab Exercise 10.24.2024 Problem 1
#Author: 
...
#open a file backwards.txt to write
#Add code here
...
for line in lines:
    #Break line apart into words and store in variable words
    #Add code here
